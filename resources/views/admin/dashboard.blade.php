...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h2 mb-0 font-weight-bold text-gray-950"><i class="fas fa-tachometer-alt mr-2"></i> Dashboard Admin</h1>
</div>
...
<div class="row mb-4">
    ...
    <div class="col-xl col-md-4 mb-4">
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" style="font-size: 0.85rem;">User</div>
                <div class="h3 mb-0 font-weight-bold text-gray-900">{{ $stats['users'] }}</div>
            </div>
        </div>
    </div>
    <div class="col-xl col-md-4 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="text-xs font-weight-bold text-info text-uppercase mb-1" style="font-size: 0.85rem;">Role</div>
                <div class="h3 mb-0 font-weight-bold text-gray-900">{{ $stats['roles'] }}</div>
            </div>
        </div>
    </div>
</div>
...
<div class="card shadow mb-4">
    <div class="card-header bg-light py-3">
        <h6 class="m-0 font-weight-bold text-dark" style="font-size: 1.1rem;"><i class="fas fa-history mr-1"></i> Booking Terbaru</h6>
    </div>
    <div class="card-body">
